(function () {
    ...
    Markdown.Editor = function (markdownConverter, idPostfix, idPrefix, options) {
        options = options || {};
        ...
        this.run = function () {
            ...
            uiManager = new UIManager(idPostfix, idPrefix, panels, undoManager, previewManager, commandManager, options.helpButton, getString);
            uiManager.setUndoRedoButtonStates();
    ...
    function UIManager(postfix, prefix, panels, undoManager, previewManager, commandManager, helpOptions, getString) {
        ...
        function makeSpritedButtonRow(prefix) {
            ...
            if (helpOptions) {
                ...
                helpButton.className = prefix + "button wmd-help-button";
