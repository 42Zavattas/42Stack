...
Question.find({}).remove(function () {
	Question.create(
		{ title   : 'question 1', content : 'vim est il reellement mieux, ou est ce sublime text ?', tags : [0, 4], author : 3 },
		{ title   : 'question 2', content : 'vim est il reellement mieux, ou est ce sublime text ?', tags : [1, 3], author : 2 }
		, function () {
