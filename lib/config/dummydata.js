...
Question.find({}).remove(function () {
	Question.create(
		{ title   : 'choix d\'editeur', upvotes : 1, downvotes : 160, content : 'vim est il reellement mieux, ou est ce sublime text ?', tags : ['editeur'], author : 3, category : 1 }
		, function () {
...
User.find({}).remove(function () {
	User.create(
		{ _id : 1, login: 'a', password : 'a', name : 'test', email : 'test@zavatta.fr' },
		{ _id : 2, login: 'bgronon', password : 'a', name : 'dawuut', email : 'dawuut@zavatta.fr' },
		{ _id : 3, login: 'mpillet', password : 'a', name : 'gongon', email : 'admin@shitter.fr' }
		, function () {
			console.log('finished populating things');
		}
	);
